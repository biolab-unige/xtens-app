...
generateDNA: function(sample){
              ...
              */ 
                 generateVariantData : function(fields) {
                     ...
                     (fields.fields).forEach(function(field){
                         ...
                         switch(field.name){
                             ...
                             case 'id':
                                 metadata[field.name] = {"value":guid()};
                             break;
                             ...
                             metadata[field.name] = {"values":values};
                             break;

                             case 'filter':
                                 if (metadata.qual.value > 10) {
                                 metadata[field.name] = {"value":'pass'};
                             }
                             else {
                             ...
                             case 'af':
                                 metadata[field.name] = {"value":getRandomArbitrary(0,1).toFixed(3)};
                             break;
                             ...
                             case 'acquisition_date':
                                 metadata[field.name] = {"value" : new Date()};
                             break;
                 ...
                 generateVariantAnnotationData : function (fields) {
                     ...
                     (fields.fields).forEach(function(field){
                         ...
                         switch(field.name){
                             ...
                             case 'deleteriousness':
                                 metadata[field.name] = {"value":pseudoRandom()};
                             break;
