...
this["JST"]["views/templates/query-builder-row.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
'</span>\n            <div class="query-field-div">\n                <select id="pivot-data-type" name="pivot-data-type" class="form-control"></select>\n            </div>\n            <button id="add-field" type="button" class="btn btn-info hidden">' +
((__t = ( __("add-field-condition") )) == null ? '' : __t) +
'</button>\n            <button id="add-loop" type="button" class="btn btn-info hidden">' +
