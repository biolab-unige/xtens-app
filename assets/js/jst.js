...
'</label>\n            <select class="form-control input-sm field-type" name="fieldType">\n                ';
...
__p += '\n            </select>\n        </div>\n        <div class="metadataField-third">\n            <label class="control-label">' +
((__t = ( __('name') )) == null ? '' : __t) +
'</label>\n            <input text class="form-control input-sm" placeholder="Field Name" name="name" \n            value="' +
...
'\n            </label>\n        </div>\n        <div class="metadataField-third">\n            <label class="control-label">' +
((__t = ( __('min') )) == null ? '' : __t) +
'</label>\n            <input text class="form-control input-sm" name="min" placeholder="Minimum Value" value="' +
((__t = ( component ? component.min : '' )) == null ? '' : __t) +
'">\n        </div>\n        <div class="metadataField-third">\n            <label class="control-label">' +
((__t = ( __('max') )) == null ? '' : __t) +
'</label>\n            <input text class="form-control input-sm" name="max" placeholder="Maximum Value" value="' +
...
'">\n        </div>\n        <div class="metadataField-third">\n            <select class="form-control input-sm" name="tableConnection" name="tableConnection">\n                <option selected value="">' +
