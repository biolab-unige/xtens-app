...
this["JST"]["views/templates/downloadFile.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '\n\n\n<script>\n\nfunction MyFunc()\n{\n$.ajax({\n            type: "POST",\n\n            url: \'/download-file\',\n           \n        });\n\n   \n}\n</script>\n<form>\n    <button id="login"type="submit"onclick="MyFunc()">Download</button>\n    \n</form>\n';
...
__p += '\n\n<!--\n<div class="query-junction">\n    <input name="junction" type="hidden" class="form-control">\n</div>\n-->\n';
...
this["JST"]["views/templates/uploadFile.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<form action="/file/upload" class="dropzone" method="post" enctype="multipart/form-data">\n  <div class="fallback">Drop here a file or (click)\n    <input name="file" type="file" multiple />\n  </div>\n</form>\n\n';
